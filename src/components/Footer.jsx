    ...
    <div className="mx-auto container px-6 md:px-0">
      <div className="flex md:items-center gap-[40px] justify-between flex-col md:flex-row py-4 border-b border-gray-400/40 ">
        ...
        <a
          ...
          className="text-[#808080] text-[14px] hover:text-[#ec5c29] cursor-pointer "
        >
        ...
        <nav className="">
          <ul className="text-[14px] text-[#808080]/60 whitespace-wrap space-x-[30px] ">
            <Link className="cursor-not-allowed text-[#808080] ">
              Follow me
            </Link>
            <Link
              className="hover:text-[#ec5c29]"
              target="_blank"
              to="https://www.linkedin.com/in/oyedele-sulaiman-a9a677210?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app"
            >
              linkedin
            </Link>
            <Link
            ...
            <Link
              className="hover:text-[#ec5c29]"
              target="_blank"
              to="https://github.com/sulyman002"
            >
              github
            </Link>
            <Link
      ...
      <div className="flex items-center flex-col md:flex-row gap-[16px] mt-10 justify-between text-[#808080]/60 text-[14px]">
        ...
        <div className=" flex items-center justify-center gap-8">
          <a href="#" className="hover:text-[#ec5c29]">
            Terms
          </a>
          <a href="#" className="hover:text-[#ec5c29]">
            Privacy
